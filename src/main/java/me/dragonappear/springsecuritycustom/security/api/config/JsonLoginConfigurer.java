...
public class JsonLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
    ...
    public JsonLoginConfigurer<H> successHandlerJson(AuthenticationSuccessHandler successHandler) {
        this.successHandler = successHandler;
        return this;
    }

    public JsonLoginConfigurer<H> failureHandlerJson(AuthenticationFailureHandler authenticationFailureHandler) {
        this.failureHandler = authenticationFailureHandler;
        return this;
    }

    public JsonLoginConfigurer<H> setAuthenticationManager(AuthenticationManager authenticationManager) {
