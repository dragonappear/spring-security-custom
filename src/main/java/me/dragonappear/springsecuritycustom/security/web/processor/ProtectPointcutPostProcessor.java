package me.dragonappear.springsecuritycustom.security.web.processor;
...
public class ProtectPointcutPostProcessor implements BeanPostProcessor {
    ...
    private final Set<org.aspectj.weaver.tools.PointcutExpression> pointCutExpressions = new LinkedHashSet<>();
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        synchronized (processedBeans) {
            ...
            for (Method method : methods) {
                for (org.aspectj.weaver.tools.PointcutExpression expression : pointCutExpressions) {
